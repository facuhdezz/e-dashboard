...
export const FormName = ({ validate, state, handleChange, isEdit, inputEdit = "add" }) => {
    return (
        <>
            {(!isEdit && (inputEdit == "nombre" || inputEdit == "add")) && <InputComp
...
export const FormDescription = ({ validate, state, handleChange, isEdit, inputEdit = "add" }) => {
    return (
        <>
            {(!isEdit && (inputEdit == "descripcion" || inputEdit == "add")) && <InputComp
                labelClass="font-semibold"
...
export const FormMoneda = ({ validate, state, handleChange, isEdit, inputEdit = "add" }) => {
    return (
        <>
            {(!isEdit && (inputEdit == "moneda" || inputEdit == "add")) && <div>
...
export const FormPrecio = ({ validate, state, handleChange, isEdit, inputEdit = "add" }) => {
    return (
        <>
            {(!isEdit && (inputEdit == "precio" || inputEdit == "add")) && <InputComp
                labelClass="font-semibold"
                label="Precio"
                type="text"
                name="precio"
...
export const FormOpcionales = ({ state, handleChange, tempOpKey, tempOpValue, currentField, updateKey, updateValue, updateField, isEdit, inputEdit = "add" }) => {
    return (
        <>
            {(!isEdit && (inputEdit == "opcionales" || inputEdit == "add")) && <div>
...
export const FormCaracteristicas = ({ state, handleChange, tempCaracKey, tempCaracValue, currentField, updateKey, updateValue, updateField, isEdit, inputEdit = "add" }) => {
    return (
        <>
            {(!isEdit && (inputEdit == "caracteristicas" || inputEdit == "add")) && <div>
...
export const FormCategoria = ({ validate, state, handleChange, isEdit, inputEdit = "add" }) => {
    return (
        <>
            {(!isEdit && (inputEdit == "categoria" || inputEdit == "add")) && <div>
...
export const FormSubcategoria = ({ validate, state, handleChange, isEdit, inputEdit = "add" }) => {
    return (
        <>
            {
...
export const FormOtros = ({ state, handleChange, isEdit, inputEdit = "add" }) => {
    return (
        <>
        {(!isEdit && (inputEdit == "otros" || inputEdit == "add")) && <InputComp
                labelClass="font-semibold"
                label="Otros"
                type="text"
                name="otros"
